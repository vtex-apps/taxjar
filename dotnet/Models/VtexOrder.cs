...
namespace Taxjar.Models
{
    public class VtexOrder
    {
        ...
        [JsonProperty("totals")]
        public List<VtexTotal> Totals { get; set; }
        ...
        public VtexPaymentData PaymentData { get; set; }
    ...
    public class AdditionalInfo
    {
        ...
        public List<VtexCategory> Categories { get; set; }
